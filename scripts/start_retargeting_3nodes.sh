...
DEVICE_CFG="${2:-${REPO_ROOT}/config/device/static_file_replay_device.yaml}"
...
DEVICE_BIN="${BUILD_DIR}/app/cpp/devices/static_file_replay_device"
...
DEVICE_LOG="${REPO_ROOT}/bin/log/static_file_replay_device.log"
...
echo "[start_retargeting_3nodes] start static file device"
