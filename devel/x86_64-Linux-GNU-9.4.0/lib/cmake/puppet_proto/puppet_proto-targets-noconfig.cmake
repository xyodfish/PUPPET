...
set_target_properties(puppet_proto::puppet_proto PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libpuppet_proto_local.so.0.1.0"
  IMPORTED_SONAME_NOCONFIG "libpuppet_proto_local.so.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS puppet_proto::puppet_proto )
list(APPEND _IMPORT_CHECK_FILES_FOR_puppet_proto::puppet_proto "${_IMPORT_PREFIX}/lib/libpuppet_proto_local.so.0.1.0" )
